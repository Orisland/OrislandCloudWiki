...
右键你的Windows按钮![](<../../.gitbook/assets/image (7) (1).png>) 或 ![](<../../.gitbook/assets/image (1) (1).png>)，选择命令提示符或Windows 终端。
...
检查可用性，右键您的Windows按钮![](<../../.gitbook/assets/image (7) (1).png>) 或 ![](<../../.gitbook/assets/image (1) (1).png>)，选择命令提示符或Windows 终端。在黑框中输入java -version，若显示的结果为您刚才已经安装的版本则代表Java环境配置完毕。
